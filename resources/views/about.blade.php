        ...
        <div class="mb-9 sm:container mx-auto min-h-[70vh]">
            <div class="pt-[3rem]">
                <div class="card bg-base-100 shadow-xl my-6">
                    <div class="card-body">
                        <h2 class="card-title">About ImageTo50kb.com</h2>
                        <p class="py-3 leading-normal text-slate-900 text-justify"><a class="text-blue-900 font-bold" style="color: green !important;" href="http://imageto50kb.com/">ImageTo50kb.com</a> is the best image Resizer tool that can resize or compress any image to 50kb. the goal of the tool is to compress any image file to an accurate 50kb size.
                            <br /> <br />When we fill any form, it is often asked to put the image size is 50kb, to solve this problem, we have made this tool so that any user can convert his photo to 50kb for his work to be able to use.
                        </p>
                    </div>
                </div>
            </div>
